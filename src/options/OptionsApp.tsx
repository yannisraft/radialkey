    ...
    <div className="app">
      ...
      <main className="main">
        {section === "activation" ? (
          <Section
            title="Activation"
            description="The wheel only appears while you are writing, and never hijacks ordinary right-click. Ctrl+Shift+G pins the wheel on screen for styling (press again to hide)."
          >
            <ActivationSection
